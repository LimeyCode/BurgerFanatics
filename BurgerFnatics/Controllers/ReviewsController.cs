...
namespace BurgerFnatics.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Review.Include(r => r.Restaurant);
        ...
        public async Task<IActionResult> Create([Bind("ReviewId,RestaurantId,Title,TasteRating,TextureRating,VisualRating,ImagePath")] Review review)
        {
            ...
            ViewData["RestaurantId"] = new SelectList(_context.Restaurant, "RestaurantId", "RestaurantId", review.RestaurantId);
            return View(review);
        }
